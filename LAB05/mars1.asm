          .data
lab_n:    .word  0x50, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x61, 0x6e, 0x64, 0x6f, 0x20, 0x6f, 0x20, 0x4d, 0x49, 0x50, 0x53, 0x0d #colocar 0x20 depois do 2o 0x6f correçao do código
count:	  .word  18
...
main:
        ...
        jal     print_string    # print it    -->>saltar para a funçao em baixo
        la	$a0,count	# -->>carregar para a0 o endereço que está em count (equivalente a um ponteiro)
        lw	$t0,0($a0)	# -->>carregar para t0 o valor de a0 de offset de zero(é como um right ou left shift)-- mesmo sendo zero é melhor colocar na mesma pq o Mars é mto permissivo
	...
	la	$a1, lab_n
loop:	
	lw 	$t2, 0($a1)	#tira o espaço entre SMP/AC e p -->> carrega para t2 o valor efetivo da string
	move 	$a0,$t2
